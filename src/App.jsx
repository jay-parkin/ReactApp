...
function App() {
  ...
  const getProtectedRoute = async () => {
    ...
    let response = await fetch(
      `${import.meta.env.VITE_AUTH_API_URL}/protectedRoute`
    );
  ...
  return (
    <>
      <div>
        ...
        <button onClick={postUserSignUp}>Sign up a user</button>
        <button onClick={getProtectedRoute}>Visit protected API route</button>
